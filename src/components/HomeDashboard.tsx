                ...
                {HOUSES.map((houseId, i) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <span className="inline-block text-[9px] font-medium uppercase tracking-wider text-fresco-graphite-light bg-fresco-light-gray border border-fresco-border px-2 py-0.5 rounded-full mb-2">
                        {house.formalLabel}
                      </span>

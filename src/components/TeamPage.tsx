...
export function TeamPage({ userId, userEmail, onUpgrade }: TeamPageProps) {
  ...
  // Team collaboration was retired June 2026 and is kept for one grandfathered
  // account only. Anyone else who reaches this view sees the retirement notice.
  if (!canUseTeams(userEmail)) {
    return (

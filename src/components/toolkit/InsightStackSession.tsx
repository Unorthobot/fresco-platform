...
export function InsightStackSession({ sessionId, workspaceId, onBack, onStartToolkit }: InsightStackSessionProps) {
  ...
  return (
    <div className="flex flex-col md:flex-row h-full bg-fresco-white">
      ...
      {/* Main Column */}
      <div ref={mainScrollRef} className={cn("flex-1 overflow-y-auto transition-all pb-16 md:pb-0", isOutputPanelExpanded ? "" : "")}>
        <div className="max-w-[800px] mx-auto px-4 md:px-8 py-6 md:py-10">
          {/* Header */}
          <div className="mb-8">
